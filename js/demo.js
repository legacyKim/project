document.addEventListener("DOMContentLoaded", function () {
    ...
    const demodemo = ["demo", "demo1", "demo2", "demo3", "demo4", "demo5", "demo6", "demo7", "demo8", "demo9", "demo10", "demo11", "demo12", "demo13", "demo14", "demo15", "demo16", "demo17", "demo18", "demo19", "demo20", "demo21", "demo22" ,"demo23", "demo24", "demo25"]
    ...
    for (var i = 0; i < demodemo.length; i++) {
        ...
        centerPosXa = totalColumnX / 2;
        centerPosXb = totalColumnX / 2 +1;

        centerPosYa = totalColumnY / 2;
        centerPosYb = totalColumnY / 2 +1;
